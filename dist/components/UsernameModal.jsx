...
const UsernameModal = ({ buttonText = "Launch Chat", noUsernameModal = false, }) => {
    ...
    return (<Container noUsernameModal={noUsernameModal}>
      <Tagline>Pick a username</Tagline>
      <Form onSubmit={handleSubmit}>
        <Input required value={user} onChange={(e) => setUser(e.target.value)} placeholder="Eg. koolz69" maxLength={20}/>
...
const Container = styled.div `
  ...
  filter: ${(props) => props.noUsernameModal
