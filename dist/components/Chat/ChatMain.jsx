...
import { streamState, receivingCallState, callerState, callerSignalState, callAcceptedState, cancelCallRequestState, pressedCallState, muteMicState, showSelfWebcamState, } from "../../store/video";
import { selfIdState, listUsersState, usernameState, userLeftChattrState, } from "../../store/users";
...
import { chatWelcomeMessageState, chatWindowState, chatUserIsTypingState, } from "../../store/chat";
...
const ChatMain = () => {
    ...
    // @ts-ignore
    const [cancelCallRequest, setCancelCallRequest] = useRecoilState(cancelCallRequestState);
    ...
    return (<>
      ...
      <OutterWrapper>
        <Wrapper>
          <LeftColumn>
            <ChatVideo socket={socket} selfVideoRef={selfVideoRef} friendVideoRef={friendVideoRef} acceptCall={acceptCall}/>
